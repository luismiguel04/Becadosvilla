                ...
                <div class="offcanvas offcanvas-start bg-white" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3 list-group">
                            ...
                            <li class="list-group-item-luis  list-group-item-action">
                                <a class="nav-link group-item-action" href="{{ route('programas.index') }}"><i class="fas fa-fw fa-list-ul fa-2x"></i>{{ __(' Programas de Becas') }}</a>
                            </li>
                            <li class="list-group-item-luis  list-group-item-action">
                                <a class="nav-link" href="{{ route('servicios.index') }}"><i class="fas fa-fw fa-map-marked-alt  fa-2x">
                            ...
                            <li class="list-group-item-luis  list-group-item-action">
                                <a class="nav-link" href="{{ route('gastos.index') }}"><i class="fas fa-fw fa-chart-line fa-2x"></i>{{ __(' Gastos Mensuales') }}</a>
                            </li>
                            <li class="list-group-item-luis  list-group-item-action ">
                                <a class="nav-link " href="{{ route('reportes.index') }}"><i class="fas fa-fw fa-file-alt fa-2x"></i>{{ __(' Reportes') }}</a>
