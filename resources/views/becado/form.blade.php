        ...
        <div class="row">
            <div class="col-sm-8">
                ...
                <div class="input-group">
                    {{ Form::text('nombre', $becado->nombre, ['class' => 'form-control','required' . ($errors->has('nombre') ? ' is-invalid' : ''), 'placeholder' => 'Nombres']) }}
                    {!! $errors->first('nombre', '<div class="invalid-feedback">:message</div>') !!}


                    {{ Form::text('ApellidoP', $becado->ApellidoP, ['class' => 'form-control','required' . ($errors->has('ApellidoP') ? ' is-invalid' : ''), 'placeholder' => 'Apellido Paterno']) }}
                    {!! $errors->first('ApellidoP', '<div class="invalid-feedback">:message</div>') !!}


                    {{ Form::text('ApellidoM', $becado->ApellidoM, ['class' => 'form-control','required' . ($errors->has('ApellidoM') ? ' is-invalid' : ''), 'placeholder' => 'Apellido Materno']) }}
            ...
            <div class="col-sm-2">
                <div class="form-group">
                    ...
                    {{ Form::text('LugarN', $becado->LugarN, ['class' => 'form-control','required' . ($errors->has('LugarN') ? ' is-invalid' : ''), 'placeholder' => 'Lugar de Nacimiento']) }}
            ...
            <div class="col-sm-9">
                <div class="form-group">
                    ...
                    {{ Form::text('DireccionP', $becado->DireccionP, ['class' => 'form-control','required' . ($errors->has('DireccionP') ? ' is-invalid' : ''), 'placeholder' => 'Dirección Permanente']) }}
            ...
            <div class="col-sm-2">
                <div class="form-group">
                    ...
                    {{ Form::text('TelefonoC', $becado->TelefonoC, ['class' => 'form-control','required' . ($errors->has('TelefonoC') ? ' is-invalid' : ''), 'placeholder' => 'Teléfono Celular']) }}
            ...
            <div class="col-sm-9">
                <div class="form-group">
                    ...
                    {{ Form::text('DireccionA', $becado->DireccionA, ['class' => 'form-control','required' . ($errors->has('DireccionA') ? ' is-invalid' : ''), 'placeholder' => 'Dirección Actual']) }}
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    {{ Form::text('NombreP', $becado->NombreP, ['class' => 'form-control','required' . ($errors->has('NombreP') ? ' is-invalid' : ''), 'placeholder' => 'Nombre del Padre']) }}
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    {{ Form::text('NombreM', $becado->NombreM, ['class' => 'form-control' ,'required' . ($errors->has('NombreM') ? ' is-invalid' : ''), 'placeholder' => 'Nombre de la Madre']) }}
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    {{ Form::text('LugarFam', $becado->LugarFam, ['class' => 'form-control','required' . ($errors->has('LugarFam') ? ' is-invalid' : ''), 'placeholder' => 'Lugar que ocupa en la familia']) }}
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    {{ Form::text('TrabajoAct', $becado->TrabajoAct, ['class' => 'form-control','required' . ($errors->has('TrabajoAct') ? ' is-invalid' : ''), 'placeholder' => 'Trabajo actual']) }}
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    {{ Form::label('Facebook') }}
                    {{ Form::text('Facebook', $becado->Facebook, ['class' => 'form-control','required' . ($errors->has('Facebook') ? ' is-invalid' : ''), 'placeholder' => 'Facebook']) }}
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    {{ Form::text('Instagram', $becado->Instagram, ['class' => 'form-control','required' . ($errors->has('Instagram') ? ' is-invalid' : ''), 'placeholder' => 'Instagram']) }}
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    {{ Form::text('ContactoEmergencia', $becado->ContactoEmergencia, ['class' => 'form-control','required' . ($errors->has('ContactoEmergencia') ? ' is-invalid' : ''), 'placeholder' => 'Contacto de Emergencia']) }}
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    {{ Form::text('TelefonoEmergencia', $becado->TelefonoEmergencia, ['class' => 'form-control','required' . ($errors->has('TelefonoEmergencia') ? ' is-invalid' : ''), 'placeholder' => 'Telefono de Emergencia']) }}
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    {{ Form::label('Carrera') }}
                    {{ Form::text('Carrera', $becado->Carrera, ['class' => 'form-control','required' . ($errors->has('Carrera') ? ' is-invalid' : ''), 'placeholder' => 'Carrera']) }}
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    {{ Form::text('Universidad', $becado->Universidad, ['class' => 'form-control','required' . ($errors->has('Universidad') ? ' is-invalid' : ''), 'placeholder' => 'Universidad']) }}
            ...
            <div class="col-sm-8">
                <div class="form-group">
                    ...
                    {{ Form::text('DireccionUni', $becado->DireccionUni, ['class' => 'form-control','required' . ($errors->has('DireccionUni') ? ' is-invalid' : ''), 'placeholder' => 'Dirección de la Universidad']) }}
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    {{ Form::label('Banco') }}
                    {{ Form::text('Banco', $becado->Banco, ['class' => 'form-control','required' . ($errors->has('Banco') ? ' is-invalid' : ''), 'placeholder' => 'Banco']) }}
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    {{ Form::text('CuentaBanc', $becado->CuentaBanc, ['class' => 'form-control','required' . ($errors->has('CuentaBanc') ? ' is-invalid' : ''), 'placeholder' => 'Cuentabancaria']) }}
