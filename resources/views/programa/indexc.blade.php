                ...
                <div class="card-header">
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        ...
                        <div class="float-right">
                            <a href="{{ route('programas.create') }}" class=" btn btn-outline-primary" data-placement="left">
                        ...
                        <table class="table table-striped table-hover" id="Table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('programas.destroy',$programa->id) }}" class="formEliminar" method="POST">
                                            ...
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-danger btn-sm"><i class="fa fa-fw fa-trash" onclick="alert"></i>
                                                {{ __('Eliminar') }}</button>
