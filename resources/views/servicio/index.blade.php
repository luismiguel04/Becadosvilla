                ...
                <div class="card-header">
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        ...
                        <div class="float-right">
                            <a href="{{ route('servicios.create') }}" class=" btn btn-outline-primary" data-placement="left">
                        ...
                        <table id=Table class="table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('servicios.destroy',$servicio->id) }}" class="formEliminar" method="POST">
